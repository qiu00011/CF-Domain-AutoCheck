...
const DEFAULT_BACKGROUND = 'https://cmcc.cc.cd/liz.jpg'; // 默认背景图片，外置变量名为BACKGROUND_URL
const DEFAULT_MOBILE_BACKGROUND = 'https://cmcc.cc.cd/liz.jpg'; // 默认手机端背景图片，留空则使用桌面端背景图片，外置变量名为MOBILE_BACKGROUND_URL
